...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "eg-fixed eg-inset-0 eg-z-50 eg-bg-black/80 data-[state=open]:eg-animate-in data-[state=closed]:eg-animate-out data-[state=closed]:eg-fade-out-0 data-[state=open]:eg-fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("eg-text-lg eg-font-semibold", className)}
    {...props}
  />
))
