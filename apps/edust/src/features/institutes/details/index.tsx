                          ...
                          <TableBody>
                            <TableRow>
                              <TableCell className="flex gap-4 sm:gap-24">
                                ...
                                <span>
                                  {data?.data?.codeType.toUpperCase()}
                                </span>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                    ...
                    >
                      <div
                        dangerouslySetInnerHTML={{
                          __html: data?.data?.overview,
                        }}
                      ></div>
                    </div>
                  )}

                  <Alert className="mt-6 lg:mt-8" variant={"destructive"}>
                    <Terminal className="h-4 w-4" />
                    <AlertTitle>Disclaimer!</AlertTitle>
                    <AlertDescription>
                      The content displayed on this page has been collected from
                      publicly available sources. While we strive to ensure
                      accuracy, there may be errors or outdated information.
                      <br />
                      If you notice any incorrect or misleading details, please
                      &nbsp;
                      <Link to={"/contact-us"} className="underline">
                        contact our support team.
                      </Link>
                      We will promptly review and correct any inaccuracies.
                    </AlertDescription>
                  </Alert>
                </>
              ) : (
